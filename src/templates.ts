...
<head>
  ...
  <link rel="alternate" type="application/rss+xml" title="EluvK" href="${site_url}/feed.xml">
  <style>
  @font-face {
...
<body>
  ...
  <footer class="site-footer">
    <p>
      <a href="https://github.com/EluvK/eluvk.github.io/edit/master${src}">
...
const blurb = "Yet another programming blog by EluvK.";
